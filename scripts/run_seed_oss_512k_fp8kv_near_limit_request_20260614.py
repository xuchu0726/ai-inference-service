...
request_path = OUT_DIR / "seed_oss_4xa100_512k_fp8kv_near_limit_request_20260614.json"
response_path = OUT_DIR / "seed_oss_4xa100_512k_fp8kv_near_limit_response_20260614.json"
summary_path = OUT_DIR / "seed_oss_4xa100_512k_fp8kv_near_limit_summary_20260614.json"

print("===== Seed-OSS 512K FP8 KV near-limit request generation =====", flush=True)
...
block = (
    "This is a deterministic long-context validation block for Seed-OSS 512K FP8 KV serving. "
    "The purpose is to stress prefill, KV cache allocation, FP8 KV cache behaviour, and OpenAI-compatible API stability. "
    "Remember the final answer must be exactly: 512K FP8 KV near-limit context test passed. "
)
...
prompt = (
    ...
    + "\n\nFinal instruction: Reply with exactly this sentence and nothing else: "
      "512K FP8 KV near-limit context test passed."
)
