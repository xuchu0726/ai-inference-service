...
| QPS、延迟、P95 优化图表 | 已覆盖并发性能图、batch-token 调优图和 FP32 vs W8A8 量化对比图。 | `figures/week2_qps_vs_concurrency_report.png`；`figures/week2_latency_p50_p95_vs_concurrency.png`；`figures/week2/batch_tokens/`；`results/figures/seed_oss_fp32_vs_w8a8_qps.png`；`results/figures/seed_oss_fp32_vs_w8a8_p95_latency.png` | 已完成 |
